    ...
    create_contract: function () {
      ...
      $("#button-click").on("click", function () {
        App.contracts.BudgetCreator.deployed().then(function (instance) {
          ...
          //if(acc != undefined) {
          instance.add_contract(document.querySelector('#budget_name').value, amount, document.querySelector('#budget_description').value, new Date().toString(), document.querySelector('#deadline').value, budget_address);
          // clearInterval(x)
          //}
          // });
          //console.log(amount);
